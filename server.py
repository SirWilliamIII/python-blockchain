...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'dev_key_123')  # Change this in production
...
def login():
    if request.method == 'POST':
        ...
        return render_template('login.html', error='Invalid credentials. Username and password must match.')
